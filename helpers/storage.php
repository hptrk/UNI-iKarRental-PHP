...
interface IStorage {
  ...
  function delete(string $fieldname, string $id);
...
class Storage implements IStorage {
  ...
  public function delete(string $fieldname, string $id) {
    $this->contents = array_filter($this->contents, function ($item) use ($fieldname, $id) {
...
if (!$usersStorage->findOne(['email' => 'admin@ikarrental.hu'])) {
  $usersStorage->add($adminUser);
}
